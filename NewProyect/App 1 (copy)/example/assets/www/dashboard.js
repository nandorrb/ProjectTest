	...
	drupalgap.views_datasource.call({
		...
		/*	window.plugins.barcodeScanner.scan(
			...
			*/
			...
			/*if (object.node.Uid==result.text)*/
			
				//if (object.node.Uid==33)
				
				//  {
				$("#dashboard_content_list").append($("<li></li>",{"html":"<a href='node.html' id='" + object.node.nid + "'>" + object.node.title + "<br> Supermercado:" + object.node.Name + "<br> Price: " + object.node.Price + "<br> Barcode:"+ object.node.Barcode}));
				//  }
			});
